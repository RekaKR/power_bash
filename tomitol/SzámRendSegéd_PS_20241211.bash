...
# Fontosabb parancsok (Unix parancs)
	...
	Compress-Archive -Path "fajl.txt" -DestinationPath "fajl.zip" 		# file tömörítés
	Compress-Archive -Path "konyvtar" -DestinationPath "konyvtar.zip"	# dir tömörítés
...
# Órai feladat
	...
	{
		write-host "Adj meg egy vigyálandó mappát:"
